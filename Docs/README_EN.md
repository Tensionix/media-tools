...
<!-- audion:release -->
[![Windows](https://img.shields.io/badge/Windows-10%20%7C%2011-0b6db8?style=flat-square&logo=windows&logoColor=white)](https://audion.dev/downloads/media-tools) [![Release](https://img.shields.io/github/v/release/Tensionix/audion-media-tools?style=flat-square&label=release&color=e08a63)](https://github.com/Tensionix/audion-media-tools/releases/latest) [![Downloads](https://img.shields.io/github/downloads/Tensionix/audion-media-tools/total?style=flat-square&label=downloads&color=5fd08a)](https://github.com/Tensionix/audion-media-tools/releases) [![License](https://img.shields.io/github/license/Tensionix/audion-media-tools?style=flat-square&color=5fd08a&logo=apache&logoColor=white&cacheSeconds=3600)](https://github.com/Tensionix/audion-media-tools/blob/main/LICENSE)

**Version 2.4.2** · 2026-08-24 · 500.2 MB

- [Direct download](https://audion.dev/get/media-tools/2.4.2/Audion_Media_Tools_v2.4.2_Full.zip) — unmetered, no rate limits
- [Project page](https://audion.dev/downloads/media-tools) — every version and how to install

`SHA-256: 40353830a9cfb2fcbf5a9c753fa494ebdf61517772d8999a5355345c0bacb8b4`
<!-- /audion:release -->
