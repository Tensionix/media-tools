...
PRESERVE_ROOT_FILES = {'.gitkeep', 'RELEASE_CHECKLIST.md', 'RELEASE_POLICY.md'}
...
def write_notices(records: list[Record], notice_path: Path, project_root: Path) -> None:
    ...
    lines.extend([
        ...
        '## Policy',
        '',
        '- Add missing baseline notices for PowerShell, Python Embedded, FFmpeg, yt-dlp, Deno, 7-Zip, fzf, and NiceGUI when they are present in the final release package.',
